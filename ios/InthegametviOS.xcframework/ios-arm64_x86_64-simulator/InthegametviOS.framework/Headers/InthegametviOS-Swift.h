...
#ifndef INTHEGAMETVIOS_SWIFT_H
#define INTHEGAMETVIOS_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="InthegametviOS",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC14InthegametviOS13FocusTvButton")
...
@property (nonatomic, strong) IBInspectable UIColor * _Nonnull normalBorderColor;
...
SWIFT_CLASS("_TtC14InthegametviOS13ITGAnswerView")
...
SWIFT_CLASS("_TtC14InthegametviOS9ITGNotice")
...
SWIFT_CLASS("_TtC14InthegametviOS11ITGShopView")
...
@interface ITGShopView (SWIFT_EXTENSION(InthegametviOS)) <UITableViewDataSource>
- (NSInteger)tableView:(UITableView * _Nonnull)tableView numberOfRowsInSection:(NSInteger)section SWIFT_WARN_UNUSED_RESULT;
- (UITableViewCell * _Nonnull)tableView:(UITableView * _Nonnull)tableView cellForRowAtIndexPath:(NSIndexPath * _Nonnull)indexPath SWIFT_WARN_UNUSED_RESULT;
@end


@interface ITGShopView (SWIFT_EXTENSION(InthegametviOS)) <UITableViewDelegate>
...
SWIFT_CLASS("_TtC14InthegametviOS15SpriteImageView")
