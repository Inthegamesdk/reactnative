...
@property (nonatomic, weak) IBOutlet UILabel * _Nullable portraitTitleLabel;
...
@property (nonatomic, weak) IBOutlet NSLayoutConstraint * _Nullable logoWidthConstraint;
@property (nonatomic, weak) IBOutlet NSLayoutConstraint * _Nullable logoContrainerWidthConstraint;
@property (nonatomic, weak) IBOutlet NSLayoutConstraint * _Nullable contentContainerViewLeftConstraint;
@property (nonatomic, weak) IBOutlet NSLayoutConstraint * _Nullable contentContainerViewRightConstraint;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC11Inthegametv12ITGCloseView")
@interface ITGCloseView : ITGInteractionView
@property (nonatomic, readonly, copy) NSArray<id <UIFocusEnvironment>> * _Nonnull preferredFocusEnvironments;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface ITGShopView (SWIFT_EXTENSION(Inthegametv)) <UITableViewDataSource, UITableViewDelegate>
