...
RCT_EXTERN_METHOD(openStats:(nonnull NSNumber *)node)
RCT_EXTERN_METHOD(openExtension:(nonnull NSNumber *)node)
...
RCT_EXTERN_METHOD(closeStats:(nonnull NSNumber *)node)
RCT_EXTERN_METHOD(closeExtension:(nonnull NSNumber *)node)
...
RCT_EXTERN_METHOD(resetUser:(nonnull NSNumber *)node)
